...
export default function WeatherCard(props) {
    ...
    return (
        <div className="weather-card" tabIndex={0}>
            <div className="weather-card-bg" style={weatherCardStyle}></div>
            ...
            <div className="weather-card-delete" onClick={() => props.removeLocationName(props.index)} onKeyDown={handleDeleteKeyDown} tabIndex={0}>
                <div className="weather-card-delete-bg" style={deleteBackgroundStyle}></div>
